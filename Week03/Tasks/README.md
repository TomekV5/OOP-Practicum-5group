...
## Задача 2
Реализирайте клас **Car**, който има
  - **Engine** - име, размер, конски сили
  - **Tyre** - размер, тип(летни, зимни, всесезонни)
  - марка, изминати километри, цена

### И поддържа следния интерфейс:
  - Конструктор, приемащ - *марка, изминати километри, цена*
  -